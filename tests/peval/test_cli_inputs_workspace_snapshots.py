...
class PevalCliInputWorkspaceSnapshotTests(unittest.TestCase):
...
""",
    ...
    def test_cli_trial_cell_path_accepts_windows_drive_path_with_wsl_mapping(
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with (
                patch("psycheval.config.WINDOWS_DRIVE_MOUNT_ROOT", mount_root),
    ...
    def test_unmapped_windows_paths_are_not_resolved_under_cwd(self) -> None:
        from psycheval._inputs.workspace_snapshots import resolved_local_path
