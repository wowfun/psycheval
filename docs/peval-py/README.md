...
reports, and provides a local Eval Workspace. It does not run Agents or score
Tasks.
...
Create and serve a local workspace:
...
- [Reports](reports.md): comparisons, notes, aliases, timing, localization, and
  cached analysis.
- [Eval Workspace](eval-workspace.md): sources, storage, selection, and exports.
