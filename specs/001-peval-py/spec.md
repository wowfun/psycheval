...
CLI that is lightweight enough to install and use on its own. It remains
independent from Psychevo's Rust workspace. It may use Python runtime dependencies
