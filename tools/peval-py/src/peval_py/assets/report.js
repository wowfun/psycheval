  ...
  return {
    ...
    start() {
      if (kind === "serve" && effects.startServePage) {
        return effects.startServePage(String(bootstrap2.renderOptions.serve_page || "home"), bootstrap2.report);
      }
...
function timelineModelDurationIsEstimate(stepMeta2) {
  return lower(stepMeta2?.duration_source).includes("estimate");
}
