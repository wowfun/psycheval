    ...
    def test_guest_login_admin_logout_and_fail_closed_authorization(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            try:
                ...
                guest_options = self.script_json(shell, "peval-py-render-options")
    ...
    def test_guest_json_xlsx_and_snapshot_exports_use_the_same_projection(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            try:
                ...
                snapshot = self.script_json(
                    snapshot_body, "peval-py-workspace-snapshot"
                )
                snapshot_report = self.script_json(snapshot_body, "peval-py-data")
