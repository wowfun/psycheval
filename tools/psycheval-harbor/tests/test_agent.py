...
from psycheval_harbor.agent import ExternalHarnessAgent
from psycheval_harbor.environment import HostEnvironment
...
def test_external_agent_runs_harness_and_validates_atif(tmp_path: Path) -> None:
    async def scenario() -> None:
        ...
        agent = ExternalHarnessAgent(
            ...
            command=f"{sys.executable} -m psycheval_harbor.canned_harness --scenario web-search",
        )
