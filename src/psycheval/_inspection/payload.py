...
def source_payload(
    ...
    *,
    ...
    if source.get("kind") == "harbor-trial":
        payload["harbor"] = compact_json(
            {
                "task_name": source.get("task_name"),
                "job_name": source.get("job_name"),
                "trial_name": source.get("trial_name"),
                "step": source.get("harbor_step"),
                "rewards": source.get("rewards"),
                "trial_evaluation": source.get("harbor_trial_evaluation"),
                "provenance": source.get("harbor_provenance"),
                "warnings": source.get("warnings"),
                "trajectory_available": source.get("trajectory_available"),
