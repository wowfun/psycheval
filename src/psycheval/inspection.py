...
from psycheval._inspection.payload import parse_source_indexes, source_payload
from psycheval._inspection.reports import inspect_report_for_args
from psycheval._inspection.validation import (
    parse_step_selectors,
    positive_int,
)
from psycheval._inspection.validation import (
    resolve_inspect_output as resolve_inspect_output,
)
from psycheval._inspection.validation import (
    validate_inspect_args as validate_inspect_args,
)
from psycheval._inspection.validation import (
    validate_inspect_raw_only_args as validate_inspect_raw_only_args,
)
from psycheval._inspection.validation import (
    validate_raw_args as validate_raw_args,
)
...
def build_inspect_payload(
    ...
    preview_chars = positive_int(
        getattr(args, "max_content_chars", None), preview_default
    )
