...
var I18N = scriptJson("peval-i18n", {});
var TOKEN_ESTIMATES = scriptJson("peval-token-estimates", {});
var RENDER_OPTIONS = scriptJson("peval-render-options", { mode: "report" });
var WORKSPACE_SNAPSHOT = scriptJson("peval-workspace-snapshot", null);
...
function data() {
  return JSON.parse($("peval-data").textContent || "{}");
}
