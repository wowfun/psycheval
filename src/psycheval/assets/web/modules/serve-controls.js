import { RENDER_OPTIONS, SUBMENU_DETAILS_SELECTOR, adapterDefaults, adminMode, closeOpenSubmenus, renderComparisonPanels, selectedKey, state, t } from "./runtime.js";
...
function bindGlobalControls() {
  ...
  document.addEventListener("keydown", event => {
    ...
    if (event.key === "Escape" && closeDetailSidebar()) return;
  });
